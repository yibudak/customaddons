...
class StatementLines(models.TransientModel):
    ...
    currency_rate = fields.Char('Currency Rate')
    sec_curr_debit = fields.Char('Secondary Currency Debit')
    sec_curr_credit = fields.Char('Secondary Currency Credit')
    sec_curr_balance = fields.Char('Secondary Currency Balance')
    dc = fields.Char('dc')
    sec_curr_dc = fields.Char('sec_curr_dc')
    total = fields.Char('Total')
    sec_curr_total = fields.Char('Secondary Currency Total')
